...
for end_date in end_dates:
    ...
    newlines.append('  <tr>  <td> Ending {0} </td> <td> <a href="xls/T1_X_{0}.xlsx">T1_X_{0}.xlsx</a> </td> <td> <a href="xls/T2_X_{0}.xlsx">T2_X_{0}.xlsx</a> </td> <td> <a href="xls/T12X_{0}.xlsx">T12X_{0}.xlsx</a></td> </tr> \n'.format(str_end_time))
